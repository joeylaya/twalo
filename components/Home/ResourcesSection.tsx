...
export function ResourcesSection(props: PostPreview) {
  return (
    <section class="py-8 w-full items-center flex flex-col gap-8 md:(flex-row gap-16 justify-evenly items-end)">
      <img class="order-last md:(w-1/3 order-first)" src="/illustrations/raising-hand.svg" alt="" />
